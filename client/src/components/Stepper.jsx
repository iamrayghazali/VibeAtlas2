...
export default function Stepper({
    ...
    return (
        ...
        >
            <div
                className={`mx-auto w-full max-w-md rounded-4xl shadow-xl ${stepCircleContainerClassName} bg-white`}
        ...
        >
            <motion.div
                variants={{
                    ...
                    active: { scale: 1, backgroundColor: "#F18F01", color: "black" },
                    complete: { scale: 1, backgroundColor: "#F18F01", color: "black" },
                }}
...
function StepConnector({ isComplete }) {
    const lineVariants = {
        ...
        complete: { width: "100%", backgroundColor: "#F18F01" },
    };
